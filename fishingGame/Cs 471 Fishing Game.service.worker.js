...
/** @type {string} */
const OFFLINE_URL = 'Cs 471 Fishing Game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Cs 471 Fishing Game.html","Cs 471 Fishing Game.js","Cs 471 Fishing Game.offline.html","Cs 471 Fishing Game.icon.png","Cs 471 Fishing Game.apple-touch-icon.png","Cs 471 Fishing Game.audio.worklet.js","Cs 471 Fishing Game.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Cs 471 Fishing Game.wasm","Cs 471 Fishing Game.pck"];
